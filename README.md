...
At a random time outside your excluded hours, DRAFTED opens your configured writing URL. Until you reach your keystroke quota, switching to another tab sends you straight back.
...
DRAFTED has only three essential settings:
...
The MVP activates **once per day**, at a random eligible time.
...
7. Open DRAFTED's settings and configure your document URL, quota, and excluded hours.
